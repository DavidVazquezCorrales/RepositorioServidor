 ...
 * @author David
 */
@WebServlet(name = "formulariSimple", urlPatterns = {"/formulariSimple"})
public class FormulariSimple extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response, boolean correcto)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet formulariSimple</title>");            
            out.println("</head>");
            out.println("<body>");
           ...
           String nombre = null;
            ...
            out.println("<p><a href='"+request.getContextPath()+"'>Men&uacet;inicial</a></p>");
            out.println("</body>");
            out.println("</html>");
        }
    }
